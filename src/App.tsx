...
// IMPORTANT: use `import.meta.env.VITE_*` directly so Vite can statically replace env vars.
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <h3 className="text-lg font-bold mt-1">
                        {match.home}{' '}
                        <span className="text-gray-500 text-sm">vs</span> {match.away}
                      </h3>
                      {match.status === 'LIVE' && (
